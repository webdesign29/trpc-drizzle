...
;
;
const configPath = __TURBOPACK__commonjs__external__node$3a$path__["default"].join(process.cwd(), "./postcss.config.js");
// Absolute paths don't work with ESM imports on Windows:
// https://github.com/nodejs/node/issues/31710
// convert it to a file:// URL, which works on all platforms
const configUrl = (0, __TURBOPACK__commonjs__external__node$3a$url__["pathToFileURL"])(configPath).toString();
